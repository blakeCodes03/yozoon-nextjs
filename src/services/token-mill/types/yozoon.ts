      ...
      "accounts": [
        {
          ...
          "isSigner": false,
          "docs": [
            "The main Yozoon configuration (needed for cross-validation)"
          ]
        },
        {
          "name": "creator",
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "System program for initializing accounts"
          ]
        },
        {
          "name": "rent",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The buyer's token account for this token"
          ]
        },
        {
          "name": "tokenTreasury",
          ...
          "isSigner": false,
          "docs": [
            "The token creator's treasury account to receive funds"
          ]
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The platform treasury to receive fees"
          ]
        },
        {
          "name": "buyer",
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The buyer's user state for referral tracking"
          ]
        },
        {
          "name": "referrer",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "Token treasury account (source of SOL for liquidity)"
          ]
        },
        {
          "name": "tokenAccount",
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          ...
          "isSigner": false,
          "docs": [
            "The seller's token account for this token"
          ]
        },
        {
          "name": "tokenTreasury",
          ...
          "isSigner": false,
          "docs": [
            "The token creator's treasury account to send SOL from"
          ]
        },
        {
          "name": "seller",
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "stakedAmount",
            "docs": [
              "Staked YOZOON tokens (used for dynamic fee reduction)"
            ],
            "type": "u64"
          },
          {
