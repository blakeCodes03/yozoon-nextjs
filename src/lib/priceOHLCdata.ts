// priceOHLCdata: pure aggregation helpers — no Prisma client needed here
...
function aggregateToFifteenMinutes(
  ...
  let currentIntervalStart =
    Math.floor(data[0].timestamp.getTime() / intervalMs) * intervalMs;
