...
const QuickBuySideDrawer = React.forwardRef<HTMLButtonElement, QuickBuySideDrawerProps>((props, ref) => {
  return (
    <div className='bg-[#1E2329] w-80 dark:bg-gray-800 shadow-lg'>
      ...
      {/* <div
        id="drawer-right-1"
        className="fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform transform translate-x-full bg-[#1E2329] w-80 dark:bg-gray-800 shadow-lg"
      >
        <h5
        ...
        <button
          data-drawer-hide="drawer-right-1"
          className="absolute top-2.5 end-2.5 w-10 h-10 cursor-pointer"
        >
          <img src="./images/right-arrow-off.png" alt="" />
        </button>
        ...
        <p className="inter-fonts text-[#6E6E6E] font-[400] text-[14px] sm:text-[16px] mt-5 pt-5">
          ...
          placed immediately. If set any one of them, a strategy order will be
          generated. You can check it on the trading page-{' '}
