        ...
        >
          ...
          <div className="relative h-50 w-full md:w-7/7">
            ...
            <div className="absolute top-0 left-0 w-full h-full text-center block lg:flex items-center justify-between px-6">
              {/* <!-- Left Side: Text --> */}
              <div className="text-center md:text-left dark:text-white text-black w-full lg:w-3/4">
                <Typography
                  variant="h1"
                  color="white"
                  className="mt-1 md-mt-0 text-[14px] md:text-[28px] font-[600] sofia-fonts dark:text-white text-black"
                >
                ...
                <Typography
                  variant="p"
                  color="white"
                  className="dark:text-[#FFFFFF] text-black text-[12px] md:text-[14px] font-[200] mt-3 md:mt-[10px] inter-fonts"
                >
