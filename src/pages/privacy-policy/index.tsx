    ...
    <>
      ...
      <main className="text-white">
        <div className="inner-head text-center px-4 pb-6 sm:pb-8 pt-8 sm:pt-18">
            <h1 className="text-white text-[22px] sm:text-[30px] text-center sofia-fonts font-[700] uppercase">Privacy
                Policy
            </h1>
        </div>
        <div className="container mx-auto px-4 py-2 lg:px-10 xl:px-25 md:py-3">
            <div className="text-center my-5 pb-6">
                <h1 className="text-white font-[700] sofia-fonts text-[22px] sm:text-[28px]">
                    YOZOON Privacy Portal
                </h1>
                <p className="text-white text-[13px] sm:text-[14px] inter-fonts font-[400] leading-6">
                    Learn how we collect, use, and protect your personal information when you use our platform.
                </p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                <div>
                    <h2 className="text-white text-[18px] sm:text-[24px] inter-fonts font-[600] mb-4">
                        Welcome to our Privacy Portal
                    </h2>
                    <p className="text-white text-[13px] sm:text-[14px] inter-fonts font-[400] mb-4 leading-6">
            ...
            <h1 className="text-white font-[700] sofia-fonts text-[22px] sm:text-[28px] text-center mb-8 pt-6">YOZOON
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-[#1E2329] p-3 sm:p-5 rounded-[20px] border-1 border-[#9A9A9A] text-center">
                    ...
                    <h2 className="text-white font-[700] sofia-fonts text-[16px] sm:text-[18px] mb-2">Transparency at All
                        Times</h2>
                    <p className="text-white inter-fonts font-[400] text-[13px] sm:text-[14px] leading-6">Our transparency
                ...
                <div className="bg-[#1E2329] p-3 sm:p-5 rounded-[20px] border-1 border-[#9A9A9A] text-center">
                    ...
                    <h2 className="text-white font-[700] sofia-fonts text-[16px] sm:text-[18px] mb-2">Data Minimization</h2>
                    <p className="text-white inter-fonts font-[400] text-[13px] sm:text-[14px] leading-6">Our transparency
                        commitment means that we keep you informed about how your
                        data is used and shared. We update this portal and our privacy notices regularly, ensuring you
                        stay informed about any changes that may affect you. This helps us empower you to make informed
                ...
                <div className="bg-[#1E2329] p-3 sm:p-5 rounded-[20px] border-1 border-[#9A9A9A] text-center">
                    ...
                    <h2 className="text-white font-[700] sofia-fonts text-[16px] sm:text-[18px] mb-2">Accountability and
                        Compliance</h2>
                    <p className="text-white inter-fonts font-[400] text-[13px] sm:text-[14px] leading-6">Our transparency
                        commitment means that we keep you informed about how your
                        data is used and shared. We update this portal and our privacy notices regularly, ensuring you
                ...
                <div className="bg-[#1E2329] p-3 sm:p-5 rounded-[20px] border-1 border-[#9A9A9A] text-center">
                    ...
                    <h2 className="text-white font-[700] sofia-fonts text-[16px] sm:text-[18px] mb-2">User's Rights and
                        Access</h2>
                    <p className="text-white inter-fonts font-[400] text-[13px] sm:text-[14px] leading-6">Our transparency
                        commitment means that we keep you informed about how your
                        data is used and shared. We update this portal and our privacy notices regularly, ensuring you
                ...
                <div className="bg-[#1E2329] p-3 sm:p-5 rounded-[20px] border-1 border-[#9A9A9A] text-center">
                    ...
                    <h2 className="text-white font-[700] sofia-fonts text-[16px] sm:text-[18px] mb-2">Data Security</h2>
                    <p className="text-white inter-fonts font-[400] text-[13px] sm:text-[14px] leading-6">Our transparency
                        commitment means that we keep you informed about how your
                        data is used and shared. We update this portal and our privacy notices regularly, ensuring you
                        stay informed about any changes that may affect you. This helps us empower you to make informed
                ...
                <div className="bg-[#1E2329] p-3 sm:p-5 rounded-[20px] border-1 border-[#9A9A9A] text-center">
                    ...
                    <h2 className="text-white font-[700] sofia-fonts text-[16px] sm:text-[18px] mb-2">Privacy by Design</h2>
                    <p className="text-white inter-fonts font-[400] text-[13px] sm:text-[14px] leading-6">Our transparency
                        commitment means that we keep you informed about how your
                        data is used and shared. We update this portal and our privacy notices regularly, ensuring you
                        stay informed about any changes that may affect you. This helps us empower you to make informed
            ...
            <div className="my-6 pt-4">
                <h3 className="text-white inter-fonts font-[700] text-[18px] sm:text-[22px]">1. Information We Collect</h3>
                <h1 className="inter-fonts text-white font-[600] text-[16px] sm:text-[18px] my-5">We collect different types
                    of information to provide and improve our services, including:</h1>
                <p className="my-5 text-white inter-fonts font-[400] text-[13px] sm:text-[14px] leading-6">Welcome to
                ...
                <h3 className="text-white inter-fonts font-[700] text-[18px] sm:text-[22px] my-5">2. How We Use Your
                    Information</h3>
                <ul className="list-disc list-inside ml-2 text-[14px]">
                ...
                <h3 className="text-white inter-fonts font-[700] text-[18px] sm:text-[22px] my-5">3. Data Sharing &
                ...
                <h3 className="text-white inter-fonts font-[700] text-[18px] sm:text-[22px] my-5">4. Data Security</h3>
                <ul className="list-disc list-inside ml-2 text-[14px]">
                    <li className="inter-fonts font-[400] leading-6">Regulatory Authorities: To comply with legal
                        requirements (e.g., AML/KYC regulations).</li>
                    <li className="inter-fonts font-[400] leading-6">Service Providers: Payment processors, security firms,
