    ...
    <>
      ...
      <main className="dark:text-white text-black">
        <div className="inner-head text-center px-4 pb-6 sm:pb-8 pt-8 sm:pt-18">
            <h1 className="dark:text-white text-black text-[22px] sm:text-[30px] text-center sofia-fonts font-[700] uppercase">Support</h1>
        </div>
        <div className="container mx-auto px-4 py-2 lg:px-10 xl:px-25 md:py-3">
            <h3 className="dark:text-white text-black inter-fonts font-[700] text-[18px] pb-3 sm:text-[22px] my-2 sm:my-6 leading-7 text-center">How Can We Help You?</h3>
            ...
            <h3 className="dark:text-white text-black inter-fonts font-[700] text-[18px] pt-7 sm:text-[22px] my-0 sm:my-6 leading-7 text-center">Contact Us Directly</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 py-9">
                <a href="mailto:">
                    <div
                        className="dark:bg-[#1E2329] bg-[#EAECEF] rounded-[15px] flex flex-col items-center justify-center p-4 border-1 border-[#9A9A9A]">
                        <img className="w-[35px] h-auto my-2" src="/assets/images/contact-mail-box.png" alt=""></img>
                        <h3 className="dark:text-white text-black sofia-fonts font-[700] text-[14px] sm:text-[16px] leading-7">Email Support
                        </h3>
                ...
                <a href="#">
                    <div
                        ...
                        <h3 className="dark:text-white text-black sofia-fonts font-[700] text-[14px] sm:text-[16px] leading-7">Telegram
                            Community</h3>
                        <p className="dark:text-white text-black inter-fonts font-[400] text-[13px] sm:text-[14px] leading-7">
                ...
                <a href="#">
                    <div
                        ...
                        <h3 className="dark:text-white text-black sofia-fonts font-[700] text-[14px] sm:text-[16px] leading-7">Twitter</h3>
                        <p className="dark:text-white text-black inter-fonts font-[400] text-[13px] sm:text-[14px] leading-7">
                ...
                <a href="#">
                    <div
                        ...
                        <h3 className="dark:text-white text-black sofia-fonts font-[700] text-[14px] sm:text-[16px] leading-7">TikTok</h3>
                        <p className="dark:text-white text-black inter-fonts font-[400] text-[13px] sm:text-[14px] leading-7">
